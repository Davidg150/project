...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { description: @league.description, image: @league.image, team: @league.team } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { description: @league.description, image: @league.image, team: @league.team } }
